defmodule Keila.Mailings.SenderAdapters.Shared.SES do
  ...
  def after_create(sender) do
    ...
    subject = KeilaWeb.Gettext.gettext("Verify Your Email for Pigeon")

    content =
      KeilaWeb.Gettext.gettext(
        "Please click on the following link to verify your email address %{email} for use with Pigeon.",
        email: email
      )
